Frontend.LegendController = Ember.ObjectController.extend({
	...
	populateLegendQuintiles: function() {
		...
		var parent = document.getElementById('quintile-5');
		parent.appendChild(q_5); 

		var q_4 = document.createElement("td");
		q_4.className = "quintile-4";
		...
		var parent = document.getElementById('quintile-4');
		parent.appendChild(q_4); 

		var q_3 = document.createElement("td");
		q_3.className = "quintile-3";
		...
		var parent = document.getElementById('quintile-3');
		parent.appendChild(q_3);

		var q_2 = document.createElement("td");
		q_2.className = "quintile-2";
		...
		var parent = document.getElementById('quintile-2');
		parent.appendChild(q_2);

		var q_1 = document.createElement("td");
		q_1.className = "quintile-1";
		...
		var parent = document.getElementById('quintile-1');
