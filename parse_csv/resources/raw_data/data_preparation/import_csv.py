...
def slice_data_from_csv():
	if len(sys.argv) == 4:
		with open(sys.argv[1], 'rb') as input_file, open(sys.argv[2], 'rb') as headers_file, open(sys.argv[3], 'wb') as output_file:
		...
		print "*********************************************************************"
		print "usage: python import_csv.py <input_file> <headers_file> <output_file>"
		print "*********************************************************************"
