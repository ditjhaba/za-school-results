...
get the app created:
    ...
    $ heroku apps:create za_schools_web
    Creating za_schools_web... done, stack is cedar
    http://za_schools_web.herokuapp.com/ | git@heroku.com:za_schools_web.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://za_schools_web.herokuapp.com deployed to Heroku

    To git@heroku.com:za_schools_web.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://za_schools_web.herokuap.com
    ["Hello" :from Heroku]
